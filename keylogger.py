...
#  Purpose   : Academic exercise — understand keystroke logging mechanisms
#  Author    : Student Assignment
#  WARNING   : Strictly for LOCAL, CONTROLLED, EDUCATIONAL use only.
#              Running this on any system without EXPLICIT written permission
#              is illegal under CFAA (USA), Computer Misuse Act (UK),
#              GDPR (EU), and PECA 2016 (Pakistan).
#              NEVER deploy outside a sandboxed / lab environment.
# =============================================================================

# =============================================================================
#  RISK ANALYSIS — Academic Discussion
# =============================================================================
#
#  1. CREDENTIAL THEFT
#     Keyloggers are among the most effective tools for stealing credentials.
#     When a user types a password into any application (browser, SSH, banking),
#     every character is silently captured before encryption is applied.
#     Real-world impact: Banking fraud, corporate espionage, identity theft.
#
#  2. PRIVACY VIOLATION
#     Every private message, email, search query, and personal note typed on
#     the infected machine is recorded. This is a severe breach of privacy,
#     punishable under GDPR (fines up to €20M) and PECA 2016 in Pakistan
#     (imprisonment up to 3 years under Section 26).
#
#  3. PERSISTENCE MECHANISMS (used by real attackers)
#     Real malware keyloggers survive reboots via:
#       - Windows Registry: HKEY_CURRENT_USER\Software\Microsoft\Windows\
#                           CurrentVersion\Run
#       - Startup folders, Task Scheduler, systemd services (Linux)
#       - DLL injection into running processes
#     This script does NOT implement these — shown for awareness only.
#
#  4. EVASION TECHNIQUES (used by real attackers)
#     - Log file hidden in system directories (e.g., C:\Windows\Temp)
#     - Logs encrypted before writing to disk
#     - Logs exfiltrated silently via HTTP/email to remote C2 server
#     - Process name disguised as legitimate (e.g., "svchost.exe")
#     This script does NOT implement these — shown for awareness only.
#
#  5. KEY COMBINATION ATTACKS
#     Capturing CTRL+C / CTRL+V can reveal clipboard contents indirectly.
#     CTRL+ALT+DEL, Windows key combos reveal system-level interactions.
#
#  6. LEGAL CONSEQUENCES
#     - USA   : Computer Fraud and Abuse Act (CFAA) — up to 10 years prison
#     - UK    : Computer Misuse Act 1990 — up to 10 years prison
#     - EU    : GDPR Article 5 — fines up to €20,000,000
#     - PAK   : PECA 2016 Section 26 — up to 3 years + fine
#
#  7. DETECTION & DEFENSE (countermeasures)
#     - Antivirus hooks: AV software monitors SetWindowsHookEx() API calls
#     - Behavioral analysis: EDR tools flag unusual keyboard API usage
#     - User awareness: Noticing slow system, unknown processes in Task Manager
#     - 2FA: Even if password is stolen, 2FA prevents account takeover
#     - Virtual keyboards: On-screen keyboards bypass some keyloggers
#     - Anti-keylogger tools: KeyScrambler, Zemana AntiLogger
#
# =============================================================================
